...
├── css/
│   ├── main.css          # 고유 디자인 시스템, 테마 변수, 버튼제국 스타일 셔머/오라 애니메이션, 히어로 랜딩, 기본 레이아웃
...
| :--- | :--- | :--- | :--- |
| **히어로 랜딩** | Section 12 | `init Landing` | logis.xyz & buttonempire 스타일 히어로 랜딩 제어 |
...
| **명예의 전당** | Section 8 | `renderRankingView()` | logis.xyz 스타일 3가지 다각도 리더보드 순위표 |
